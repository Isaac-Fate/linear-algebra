...
\end{align*}
through the Gram-Schmidt process (Corollary~\ref{cor:4}).
...
\begin{note}
	We have seen in Example~\ref{eg:4} that
...
\begin{proposition} \label{pro:11}
...
\begin{proposition} \label{pro:7}
	...
	\begin{enumerate}
		...
		\item $\im T^\ast = (\ker T)^\perp$
		\item $\ker T = (\im T^\ast)^\perp$
		\item $\im T = (\ker T^\ast)^\perp$
	\end{enumerate}
\end{proposition}
...
\begin{proof}
	...
	on both sides of 1 (due to Corollary~\ref{cor:7}).
	Hence, we only need to prove 1.

	We have 
	\begin{align*}
		& \mathbf{w} \in \ker T^\ast \\
		\iff& T^\ast \mathbf{w} = \mathbf{0} \\
		\iff& \langle \mathbf{v}, T^\ast \mathbf{w} \rangle = 0
		\quad \forall \mathbf{v} \in V \\
		\iff& \langle T \mathbf{v}, \mathbf{w} \rangle = 0
		\quad \forall \mathbf{v} \in V \\
		\iff& \mathbf{w} \in (\im T)^\perp
	\end{align*}
...
Inspired by Example~\ref{eg:4}, one may conjecture that
...
\begin{theorem} \label{thm:16}
	...
	\begin{align*}
		[T^\ast]_{\mathcal{B}_2 \mathcal{B}_1} = 
		[T]^{H}_{\mathcal{B}_2 \mathcal{B}_1}
	\end{align*}
\end{theorem}
...
\begin{proof}
	...
	\begin{align}
		\langle T \mathbf{u}, \mathbf{w} \rangle = 0
	...
	\end{multline*}
	Therefore, we see that \eqref{eq:45} indeed holds.
\end{proof}

It should be emphasized that Proposition~\ref{pro:8} does not hold
in general if $V$ is over a \textit{real} field.
...
\begin{example} \label{eg:6}
	...
	we have 
	\begin{align*}
		\langle T \mathbf{v}, \mathbf{v} \rangle
		&= \langle T (a\mathbf{e}_1 + b\mathbf{e}_2), 
		a\mathbf{e}_1 + b \mathbf{e}_2 \rangle \\
		&= a^2 \langle T \mathbf{e}_1, \mathbf{e}_1 \rangle
		+ ab \langle T \mathbf{e}_1, \mathbf{e}_2 \rangle
		+ ba \langle T \mathbf{e}_2, \mathbf{e}_1 \rangle
		+ b^2 \langle T \mathbf{e}_2, \mathbf{e}_2 \rangle \\
		&= a^2 \cdot 0 + ab \cdot 1 + ba \cdot (-1) + b^2 \cdot 0 \\
		&= 0
	\end{align*}
	Note that \eqref{eq:46} is satisfied. 
...
\begin{note}
	...
	Using the same example (Example~\ref{eg:6}),
	we see that \eqref{eq:47} is satisfied 
...
\begin{proof}
	...
	\begin{align}
		\langle T \mathbf{v}, \mathbf{v} \rangle
		- \overline{\langle T \mathbf{v}, \mathbf{v} \rangle}
		&= \langle T \mathbf{v}, \mathbf{v} \rangle
		- \langle \mathbf{v}, T \mathbf{v} \rangle \nonumber \\ 
		&= \langle T^\ast \mathbf{v}, \mathbf{v} \rangle \nonumber \\
		&= \langle (T - T^\ast) \mathbf{v}, \mathbf{v} \rangle
		\label{eq:48}
	\end{align}

	If \eqref{eq:47} holds, then \eqref{eq:48} yields that 
	\begin{align*}
		\langle (T - T^\ast) \mathbf{v}, \mathbf{v} \rangle
		\quad \forall \mathbf{v} \in V
	\end{align*}
	It then follows from Proposition~\ref{pro:8} 
	that $T - T^\ast$ is the zero map, 
	equivalently, $T$ is self-adjoint.

	Conversely, if $T$ is self-adjoint, then \eqref{eq:48} 
	implies \eqref{eq:47}.
\end{proof}

%------------------------------

We have already seen satisfying \eqref{eq:46} does not imply
...
\begin{proof}
	...
	Therefore, the right-hand side of \eqref{eq:49}
	reduces to $2 \langle T\mathbf{u}, \mathbf{w} \rangle$
	and hence \eqref{eq:50} follows.
\end{proof}
...
\begin{definition} \label{def:5}
	Let $V$ be a finite-dimensional inner product space.
	Operator $T \in \mathcal{L}(V)$ is said to be \textbf{normal}\index{normal operator} if 
...
\begin{solution}
	...
	\begin{align*}
		...
		\end{cases}
	\end{align*}
	Therefore, in this case, $T T^\ast = T^\ast T$ 
	(and in fact equating the identity), 
...
\begin{proof}
	...
	\begin{align*}
		...
		- \langle T^\ast \mathbf{v}, T^\ast \mathbf{v} \rangle \\
		&= \langle \mathbf{v}, T^\ast T \mathbf{v} \rangle
		- \langle \mathbf{v}, T T^\ast \mathbf{v} \rangle \\
		&= \langle \mathbf{v}, (T^\ast T - T T^\ast) \mathbf{v} \rangle
	\end{align*}
	Therefore, 
	\begin{align*}
		\norm{T \mathbf{v}} = \norm{T^\ast \mathbf{v}}
		...
		\quad \forall \mathbf{v} \in V \\
		&\iff T^\ast T - T T^\ast = 0
	\end{align*}
	where the last step follows from Proposition~\ref{pro:9} 
...
We have seen in Proposition~\ref{pro:11} that
...
\begin{proof}
	...
	\end{align*}
	It then follows from Proposition~\ref{pro:10}
	that 
	\begin{align*}
...
\begin{proof}
	...
	We have 
	\begin{align}
		\langle \mathbf{v}_1, T \mathbf{v}_2 \rangle
	...
	\begin{align}
		...
		\label{eq:52}
	\end{align}
	where the second last equality follows from Corollary~\ref{cor:9}.
	Taking the difference on the sides of \eqref{eq:51} and \eqref{eq:52}
	yields
	\begin{align*}
...
\begin{proof}
	...
	\begin{align*}
		...
		\end{bmatrix}
	\end{align*}
	Since $\mathcal{B}$ is orthonormal, by Theorem~\ref{thm:16},
	we have 
	\begin{align*}
		[T^\ast]_{\mathcal{B}} =
		[T]^{H}_{\mathcal{B}}
	...
	\begin{align*}
		...
		\quad \forall \mathbf{v} \in V
	\end{align*}
	Therefore, $T$ is a normal operator by Proposition~\ref{pro:10}.
	...
	\begin{align*}
		...
		\end{bmatrix}
	\end{align*}
	By applying the Gram-Schmidt process (Corollary~\ref{cor:4}), 
...
\end{align*}
is invertible, 
where $\alpha$ and $\beta$ satisfy \eqref{eq:53}.
...
\begin{proof}
	To show operator \eqref{eq:55} is invertible,
	it suffices to that it is injective.
	Equivalently, we need to show the kernel of 
	the operator \eqref{eq:55} is $\{\mathbf{0}\}$.
	Setting
	\begin{align}
		(T^2 + \alpha T + \beta I) \mathbf{v} = \mathbf{0}
		\label{eq:56}
	\end{align}
	we want to show $\mathbf{v} = \mathbf{0}$.
	Clearly, by \eqref{eq:56}, we have 
	\begin{align}
		\langle (T^2 + \alpha T + \beta I) \mathbf{v}, \mathbf{v} \rangle = 0
		\label{eq:57}
	\end{align}

	Similar to \eqref{eq:54}, we have 
	\begin{align*}
		T^2 + \alpha T + \beta I 
		= \brk{T + \frac{\alpha}{2} I}^2 + \brk{\beta - \frac{\alpha^2}{4}} I
	\end{align*}
	Plugging into \eqref{eq:57}, we find 
	\begin{align*}
		&\langle \brk{T + \frac{\alpha}{2} I}^2 \mathbf{v}, \mathbf{v} \rangle 
		+ \brk{\beta - \frac{\alpha^2}{4}} \langle \mathbf{v}, \mathbf{v} \rangle 
		= 0 \\
		\implies & \langle \brk{T + \frac{\alpha}{2} I} \mathbf{v}, \brk{T + \frac{\alpha}{2} I}^\ast \mathbf{v} \rangle 
		+ \brk{\beta - \frac{\alpha^2}{4}} \langle \mathbf{v}, \mathbf{v} \rangle 
		= 0 \\ 
		\implies & \langle \brk{T + \frac{\alpha}{2} I} \mathbf{v}, 
		\brk{T^\ast + \overline{\brk{\frac{\alpha}{2}}} I^\ast} \mathbf{v} \rangle 
		+ \brk{\beta - \frac{\alpha^2}{4}} \langle \mathbf{v}, \mathbf{v} \rangle 
		= 0 \\
	\implies & \langle \brk{T + \frac{\alpha}{2} I} \mathbf{v}, \brk{T + \frac{\alpha}{2} I} \mathbf{v} \rangle 
		+ \brk{\beta - \frac{\alpha^2}{4}} \langle \mathbf{v}, \mathbf{v} \rangle 
		= 0
	\end{align*}
...
Recall Theorem~\ref{thm:2}, which says
...
\begin{proof}
	...
	Equation \eqref{eq:58} is reduced to 
	\begin{align}
		a_0 \mathbf{v} + a_1 T \mathbf{v} + \cdots 
		+ a_m T^m \mathbf{v} 
		= \mathbf{0}
	...
	\begin{align}
		...
		\label{eq:60}
	\end{align}
	By Theorem~\ref{thm:5}, $p(x)$ can be factorized as 
	\begin{align}
	...
	by \eqref{eq:59} and \eqref{eq:60}, we find
	\begin{align*}
		p(T) \mathbf{v} = \mathbf{0}
	\end{align*}
	It then follows from \eqref{eq:61} that 
	\begin{align}
		...
		\label{eq:62}
	\end{align}
	By Lemma~\ref{lem:2}, we know each 
	operator $T^2 + \alpha_j T + \beta_j I$ is invertible,
	and hence $\mathbf{w} \neq \mathbf{0}$ since $\mathbf{v}$ is nonzero.
	Dropping the nonzero scalar $a_m$, \eqref{eq:62} reduces to 
	\begin{align}
		(T - \lambda_1 I) \cdots (T - \lambda_k I) \mathbf{w} = \mathbf{w}
		\label{eq:63}
	\end{align}
	Assume $T$ does not have an eigenvalue, then each 
	operator $T - \lambda_j I$ is injective, 
	which further implies the left-hand side of \eqref{eq:63} is nonzero
